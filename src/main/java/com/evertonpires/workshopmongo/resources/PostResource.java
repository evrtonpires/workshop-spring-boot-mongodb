...
import com.evertonpires.workshopmongo.resources.util.URL;
import com.evertonpires.workshopmongo.service.PostService;

@RestController//classe de recursuo Rest
@RequestMapping(value="/posts")//caminho do enpoint
